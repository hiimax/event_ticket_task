...
T useGestureRecognizer<T extends GestureRecognizer>(GestureRecognizerBuilder<T> builder, [List<Object?>? keys]) {
  return use(
...
class _GestureRecognizerHookState<T extends GestureRecognizer> extends HookState<T, _GestureRecognizerHook<T>> {
